...
Don't be afraid to contribute to the development this project! Even if you don't think you've contributed much, it's still greatly appreciated.
...
* List all operating system names and versions involved in the issue, as well as the XCode version and packages.
